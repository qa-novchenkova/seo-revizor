...
const SHAPES = {
  ...
  send: '<path d="M21.4 3.2 2.8 10.4l6.6 2.4 2.4 6.6z"/><path d="M9.4 12.8 21.4 3.2"/>',
  file: '<path d="M13.6 3.4H7a2 2 0 0 0-2 2v13.2a2 2 0 0 0 2 2h10a2 2 0 0 0 2-2V8.8z"/><path d="M13.6 3.4v5.4H19"/>',
  wallet: '<rect x="3.2" y="6" width="17.6" height="13" rx="2.6"/><path d="M3.2 10.4h17.6"/><circle cx="16.6" cy="14.6" r="1.3"/>',
  github:
