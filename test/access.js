...
assert.equal(matchCode('первое-слово')?.code, 'первое-слово', 'код без даты работает всегда')
assert.equal(matchCode('второе-слово')?.code, 'второе-слово', 'код действует в последний свой день')
...
assert.equal(matchCode(' Первое-Слово ')?.code, 'первое-слово', 'регистр и пробелы не мешают')
